...
try {
    ...
    $cases = @(
        ...
        [pscustomobject]@{ Name = "LargePathWindowsContainsSingleChar"; Keyword = "C:\Windows d"; PathScope = "C:\Windows"; Filter = [MftScanner.SearchTypeFilter]::All; Scenario = "LargePathScope"; Language = "Ascii" },
        [pscustomobject]@{ Name = "LargePathWindowsContainsTwoChars"; Keyword = "C:\Windows ve"; PathScope = "C:\Windows"; Filter = [MftScanner.SearchTypeFilter]::All; Scenario = "LargePathScope"; Language = "Ascii" },
        [pscustomobject]@{ Name = "LargePathUsersContainsSingleChar"; Keyword = "C:\Users d"; PathScope = "C:\Users"; Filter = [MftScanner.SearchTypeFilter]::All; Scenario = "LargePathScope"; Language = "Ascii" },
        [pscustomobject]@{ Name = "LargePathUsersContainsTwoChars"; Keyword = "C:\Users ve"; PathScope = "C:\Users"; Filter = [MftScanner.SearchTypeFilter]::All; Scenario = "LargePathScope"; Language = "Ascii" },
        [pscustomobject]@{ Name = "LargePathRepoContainsCode"; Keyword = "$repoRoot code"; PathScope = $repoRoot; Filter = [MftScanner.SearchTypeFilter]::All; Scenario = "LargePathScope"; Language = "Ascii" },
